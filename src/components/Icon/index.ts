...
export const AttachmentIcon = ({ width = 32, ...props } = {}): string => html`
...
export const ArrowIcon = ({ width = 16, ...props } = {}): string => html`
...
export const PlusIcon = (props = {}): string => html`
...
export const DeleteIcon = (props = {}): string => html`
<svg ${props} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
  <circle cx="11" cy="11" r="10.25" stroke="#3369F3" stroke-width="1.5"/>
...
export const LocationIcon = (props = {}): string => html`
<svg ${props} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const FileIcon = (props = {}): string => html`
<svg ${props} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const MediaIcon = (props = {}): string => html`
<svg ${props} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const MenuIcon = (props = {}): string => html`
